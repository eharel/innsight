...
export function Button<E extends ElementType = 'button'>({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary/50';
  ...
  const variantClasses = {
    ...
    outline: 'bg-transparent border border-border text-text-base hover:bg-bg-base',
  ...
  return (
    ...
    >
      ...
      {icon && iconPosition === 'left' && !isLoading && <span className="icon">{icon}</span>}
      <span>{children}</span>
